...
file_pd=None
cp = {
    "account": st.secrets["snowflake_db"]["account"],
    "user": st.secrets["snowflake_db"]["user"],
    "password": st.secrets["snowflake_db"]["password"],
    "role": st.secrets["snowflake_db"]["role"],
    "warehouse": st.secrets["snowflake_db"]["warehouse"],
    "database": st.secrets["snowflake_db"]["database"],
    "schema": st.secrets["snowflake_db"]["schema"]
}
​
def create_session():
